...
public sealed class IdentifierSourceGenerator : AttributeIncrementalGeneratorBase
{
    public IdentifierSourceGenerator()
        ...
        {
            AttributeFullyQualifiedName = AttributeFullyQualifiedName,
    ...
    private const string AttributeNamespace = "Domain.Common.Attributes";

    private const string AttributeFullyQualifiedName = $"{AttributeNamespace}.GeneratedIdentifierAttribute`1";
    ...
    private static string GenerateIdentifier(Symbol symbol)
    {
        return $$"""
                 // <auto-generated/>
